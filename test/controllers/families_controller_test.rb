...
class FamiliesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family" do
    assert_difference('Family.count') do
      post families_url, params: { family: { phonologie: @family.phonologie, roman: @family.roman, rune: @family.rune } }
    end
  ...
  test "should update family" do
    patch family_url(@family), params: { family: { phonologie: @family.phonologie, roman: @family.roman, rune: @family.rune } }
